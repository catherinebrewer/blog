...
### False positives
Misidentifying innocent acts as catastrophic acts [limits free thought](#harms-to-free-thought) and [disincentivises weirdness](#disincentivises-weirdness).
...
[^2]: I think there are a few ways a response could be the best:
	1. If it is the *most effective* response
		i. i.e. reduces vulnerability risk the most
		ii. i.e. reduces overall risk the most
2. If it is the *least costly* response
	i. i.e. weighing the benefits of risk reduction against the harms of possible interventions, it has the highest expected value
	ii. i.e. for a given 'intervention harm budget', it delivers the greatest risk reduction
	iii. i.e. for a given 'risk reduction quota', it has the smallest intervention harm
